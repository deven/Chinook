#!/usr/bin/env perl
#
# File bootstrapped by RapidApp 1.3201
#
...
my $app_class   = 'Chinook';
my $model_class = 'Chinook::Model::DB';
...
=head1 NAME
model_DB_updater.pl - updater script for RapidDbic model 'Chinook::Model::DB'
